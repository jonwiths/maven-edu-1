...
const Footer = () => {
  return (
    <>
      <footer className="p-4 sm:p-6  bg-gray-900 font-[Poppins]">
        <div className="md:flex md:justify-between">
          <div className="mr-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <img src={navLogo} alt="" className="mr-3 h-20" />
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <div className="flex flex-col text-gray-400" id="quick-links">
                ...
                <Link to="/about-us" className="hover:underline mb-4">
                  About us
                </Link>
                <Link to="/services" className="hover:underline mb-4">
                  Courses
                </Link>
                <Link to="/become-a-mentor" className="hover:underline mb-4">
                  Become a mentor
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col text-gray-400">
                <p to="#" className="hover:underline mb-4 cursor-pointer">
