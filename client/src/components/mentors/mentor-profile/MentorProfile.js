    ...
    try {
      const getProfileMentor = async () => {
        const response = await axios.get(
          'https://mave-edu.herokuapp.com/api/mentor/profile/profile',
          {
            headers: {
  ...
  useEffect(() => {
    try {
      const getProfileMentor1 = async () => {
        const response = await axios.get(
          'https://mave-edu.herokuapp.com/api/mentor/profile/about',
          {
            headers: {
              Authorization: localStorage.getItem('jwt'),
              'Content-Type': 'application/json',
  ...
  useEffect(() => {
    try {
      const getProfileMentor2 = async () => {
        const response = await axios.get(
          'https://mave-edu.herokuapp.com/api/mentor/profile/education',
          {
            headers: {
              Authorization: localStorage.getItem('jwt'),
              'Content-Type': 'application/json',
